...
const TransactionList = ({transactions, getDetailHref, error}:Props) => { //transactionsの中身を変数として取り出す(関数の引数)
    return (
        ...
        <div className="grid gap-4">
            ...
            <h2 className="text-lg font-semibold">入金一覧</h2>
                ...
                <TransactionTable transactions={transactions} getDetailHref={getDetailHref} />
