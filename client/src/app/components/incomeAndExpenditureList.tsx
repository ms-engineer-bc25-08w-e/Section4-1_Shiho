...
const TransactionList = ({ transactions, getDetailHref, error, onDelete }: Props) => {
  ...
  return (
    ...
    <div className="grid gap-4">
      ...
      <TransactionTable transactions={transactions} getDetailHref={getDetailHref} onDelete={onDelete} />
    </div>
  );
};
