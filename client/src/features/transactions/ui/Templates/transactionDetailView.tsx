...
export default function TransactionDetailView({
    ...
    if (!transaction){
        return (
            ...
            <div className="mx-auto max-w-4xl p-6 grid gap-6">
                ...
                <a href="/" className="underline underline-offset-4 hover:text-pink-300">一覧へ戻る</a>
            </div>
        );
    }
    ...
    //                     <dl className="grid grid-cols-[80px_16px_1fr] gap-y-2 rounded-lg border border-slate-200 p-4 bg-red-100">
    //                         <dt className="font-medium text-slate-700">日付</dt>
    //                         <dd className="text-slate-700">：</dd>
    //                         <dd className="text-slate-700">{transaction.date}</dd>
    //                         <dt className="font-medium text-slate-700">収支</dt>
    //                         <dd className="text-slate-700">：</dd>
    //                         <dd className="text-slate-700">{transaction.type === "income" ? "収入" : "支出"}</dd>
    //                         <dt className="font-medium text-slate-700">カテゴリ</dt>
    //                         <dd className="text-slate-700">：</dd>
    //                         <dd className="text-slate-700">{transaction.categoryName}</dd>
    //                         <dt className="font-medium text-slate-700">金額</dt>
    //                         <dd className="text-slate-700">：</dd>
    //                         <dd className="text-slate-700">{transaction.amount.toLocaleString()}</dd>
    //                         <dt className="font-medium text-slate-700">メモ</dt>
    //                         <dd className="text-slate-700">：</dd>
    //                         <dd className="text-slate-700">{transaction.title}</dd>
    //                     </dl>
                    
    //                     <div className="grid gap-3">
    //                         <button
    //                             className="mt-2 rounded-md bg-pink-600 px-1 py-2 text-sm font-semibold text-white hover:bg-pink-400"
    //                             onClick={onStartEdit}
    //                             type="button"
    //                         >
    //                             編集
    //                         </button>
    //                         <br />
    //                         <a href="/" className="underline underline-offset-4 hover:text-pink-200">
    //                             一覧へ戻る
    //                         </a>
    //                     </div>
    //                 </div>    
